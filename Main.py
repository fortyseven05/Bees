    ...
    while epoch < max_epochs:
        ...
        for i in range(nb):  # process each bee
            if hive[i].status == 1:  # active bee
                ...
                ri = rd.randint(0, nc - 1)  # random index
...
city_dist = CityData.create_city_coordinates()
city_names = CityData.create_city_names()
num_cities = 128
num_bees = 50
max_epochs = 250000
